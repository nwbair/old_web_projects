...
<body>
<h1 align="center"><?php echo count($data); ?> New Customer Calls Last 7 Days</h1>
<table class="zebra-striped" id="sortTableExample">
		<thead>
		           <tr>              
                <th>Date Added</th><th>Account</th><th>Firm Name</th><th>Ticket History</th><th>Assigned</th><th>Date Closed</th><th>Who Called</th><th>Ticket Number</th>
				</tr>
				</thead>
            ...
            <?php foreach ($data as $item): ?>
                    <tr>
						...
						<?php if(!preg_match("([0-9]{7})", $item->ticketnum)) { ?>
