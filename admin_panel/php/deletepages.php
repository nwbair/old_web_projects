			...
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                    	...
                    	<li><a href="deletpages.html" class="active">Delete pages</a></li>
                    </ul>
                ...
                <h2><a href="#">Manage Pages</a> &raquo; <a href="#" class="active">Delete Pages</a></h2>
             	<div id="main"><br>
...
<td><a href="delpgconfirm.php?id=<? echo $rows['ID']; ?>"><img src="../style/img/DeleteRed.png" /></a></td>
</tr>
<?
