			...
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                    	...
                    	<li><a href="deleteusers.php" class="active">Delete Users</a></li>
						<li><a href="userlist.php" >User List</a></li>
                    </ul>
                    
                </div>    
               
                <h2><a href="#">Manage Users</a> &raquo; <a href="#" class="active">Delete Users</a></h2>
                <div id="main"><br>
...
<td><a href="delconfirm.php?id=<? echo $rows['ID']; ?>"><img src="../style/img/DeleteRed.png" /></a></td>
</tr>
<?
