...
<tr><td>Email:</td><td><input type="text" name="email" maxlength="50" value=""></td><td><?php echo $_SESSION['email'] ?></td></tr>
...
<tr><td>Home Phone #:</td><td><input type="text" name="hphone" maxlength="15"></td></tr>
<tr><td>Cell Phone #:</td><td><input type="text" name="cphone" maxlength="15"></td></tr>
<tr><td>Cell Provider (e.g. Sprint, AT&T, etc...):</td><td><input type="text" name="cprovider" maxlength="20"></td></tr>
...
<tr><td>Availability: <br />Hold CTRL to select multiple.</td><td><select multiple="multiple" size="5" name="availability">
