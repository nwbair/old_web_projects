			...
			<tr>
				...
				<?php if ($county->statusId == '1'): ?>
                                ...
                                <?php echo $county->statusName ?></td>
                                    <td><a href='<?php echo base_url() ?>admin/county/activate/<?php echo $county->countyId ?>'>Activate</td>
                                    <td><a href='<?php echo base_url() ?>admin/county/deactivate/<?php echo $county->countyId ?>'>Deactivate</td>
