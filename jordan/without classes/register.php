...
<html>
<title>ict-Skywarn.org Registration Page</title>
<body>
...
<tr><td>Home Phone #:</td><td><input type="text" name="hphone" maxlength="75"></td></tr>
<tr><td>Cell Phone #:</td><td><input type="text" name="cphone" maxlength="75"></td></tr>
<tr><td>Cell Provider:</td><td><input type="text" name="cprovider" maxlength="75"></td></tr>
<tr><td>Work Phone #:</td><td><input type="text" name="workphone" maxlength="75"></td></tr>
<tr><td>Availability: <br />Hold CTRL to select multiple.</td><td><select multiple="multiple" size="5">
...
<tr><td>Echolink Ready:</td><td><select name="echo">
															<option value="yes">Yes</option>
															<option value="no">No</option>
														</select></td></tr>
<tr><td>Monitoring Capability:</td><td><input type="text" name="monitoring" maxlength="75"></td></tr>
<tr><td>Last Weather Brief Attended:</td><td><input type="text" name="brief" maxlength="75"></td></tr>
